...
11. **Arabic WhatsApp messaging**: the prefilled WhatsApp templates (currently English, e.g. "Hello Zenith Line, I would like to enquire about...") need Arabic equivalents on Arabic pages, using the same verified WhatsApp number (`96565071368` — not the call number) and the same structured-field format, translated with the same domain-review rigor as the page content itself.
